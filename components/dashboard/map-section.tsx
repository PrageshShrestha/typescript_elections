...
import { MapPin, Users, ChevronRight, ArrowLeft, Eye, User, User2 } from "lucide-react"

// Actual municipalities from the backend real_dataset
const ACTUAL_MUNICIPALITIES = [
...
// SVG paths for actual municipalities from Kavre district
// Coordinates arranged to represent the actual geographic layout
const MUNICIPALITY_PATHS: MunicipalityGeo[] = [
  {
    id: "chorideurali",
    name: "चोंरीदेउराली गाउँपालिका",
    shortName: "चोंरीदेउराली",
    // Western area - rural municipality
  ...
  },
  {
    ...
    shortName: "नमोबुद्ध",
    // Central area - important Buddhist site
  ...
  },
  {
    ...
    shortName: "रोशी",
    // Eastern area - along the Roshi river
  ...
  },
  {
    ...
    shortName: "खानीखोला",
    // North-east area
    path: "M 558 125 L 588 155 L 615 180 L 635 210 L 640 245 L 625 275 L 600 295 L 570 305 L 540 295 L 520 275 L 515 250 L 520 220 L 535 195 L 548 148 Z",
    labelX: 575,
    labelY: 215,
    baseColor: "#f59e0b",
    hoverColor: "#d97706",
  },
  {
    ...
    shortName: "धुलिखेल",
    // Central-east - district headquarters
    path: "M 425 305 L 455 320 L 485 335 L 515 340 L 545 325 L 570 305 L 560 280 L 540 265 L 515 270 L 490 275 L 465 265 L 440 280 L 425 295 Z",
    labelX: 485,
    labelY: 305,
    baseColor: "#ef4444",
    hoverColor: "#dc2626",
  ...
  {
    id: "namobuddha-metro",
    name: "नगरपालिका नमोबुद्ध",
    shortName: "न. नमोबुद्ध",
    // South-central area
    path: "M 280 290 L 320 295 L 355 322 L 380 325 L 400 310 L 385 285 L 365 270 L 340 265 L 315 275 L 295 280 Z",
    labelX: 340,
    labelY: 295,
    baseColor: "#06b6d4",
    hoverColor: "#0891b2",
  ...
  {
    id: "panauti",
    name: "पनोती नगरपालिका",
    shortName: "पनोती",
    // Far south area
    path: "M 225 292 L 255 295 L 280 320 L 265 345 L 240 350 L 215 340 L 200 320 L 210 295 Z",
    labelX: 240,
    labelY: 320,
    baseColor: "#84cc16",
    hoverColor: "#65a30d",
  },
  {
    ...
    shortName: "बेथानचोक",
    // Far eastern area - small municipality
    path: "M 570 305 L 600 295 L 625 310 L 635 340 L 620 365 L 595 370 L 570 355 L 565 330 Z",
    labelX: 600,
    labelY: 335,
    baseColor: "#a855f7",
    hoverColor: "#9333ea",
...
// Outer boundary of the entire constituency - updated to include all actual municipalities
const BOUNDARY_PATH =
...
export function MapSection() {
  ...
  const municipalityStats = useMemo(() => {
    const stats: Record<
      string,
      { total: number; male: number; female: number; wards: Set<string>; booths: Set<string> }
    > = {}
    voters.forEach((v) => {
      if (!stats[v.municipality])
        stats[v.municipality] = { total: 0, male: 0, female: 0, wards: new Set(), booths: new Set() }
      stats[v.municipality].total++
      if (v.gender === "Male") stats[v.municipality].male++
      else if (v.gender === "Female") stats[v.municipality].female++
      // Removed "Other" gender - only Male and Female
